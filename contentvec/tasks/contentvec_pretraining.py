...
@register_task("contentvec_pretraining", dataclass=ContentvecPretrainingConfig)
class ContentvecPretrainingTask(FairseqTask):

    cfg: ContentvecPretrainingConfig
    ...
    def __init__(
        ...
        logger.info(f"ContentvecPretrainingTask Config {cfg}")
    ...
    @classmethod
    def setup_task(
        cls, cfg: ContentvecPretrainingConfig, **kwargs
    ...
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        self.datasets[split] = ContentvecDataset(
            manifest,
